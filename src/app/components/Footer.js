      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-white font-bold text-lg">GymEquip Store</h3>
            <p className="text-sm text-gray-400 leading-relaxed">
              Your trusted source for premium gym equipment. Quality products for your fitness journey.
            </p>
            <Link 
              to="/about" 
              className="inline-block text-sm text-gray-300 hover:text-white transition-colors duration-200"
            >
              Learn more about us →
            </Link>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-gray-500">
              &copy; {new Date().getFullYear()} GymEquip Store. All rights reserved.
            </p>
